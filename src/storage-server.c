...
void initiate_SS()
{
    ...
    int size_ = sizeof(struct StorageServerInfo) + sizeof(struct DirectoryInfo) * file_structure.numberOfDirectories + sizeof(struct FileInfo) * file_structure.numberOfFiles;
    printf("size : %d\n", size_);
